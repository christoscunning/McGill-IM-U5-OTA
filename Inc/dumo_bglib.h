...
#define	dumo_cmd_system_get_info_id                                 	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0B010000)
#define	dumo_cmd_system_get_app_version_id                          	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0C010000)
...
#define	dumo_cmd_bt_gap_set_power_vector_id                         	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0C020000)
...
#define	dumo_cmd_le_gap_enable_accept_list_filtering_id             	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0D030000)
...
#define	dumo_cmd_hardware_set_spi_configuration_id                  	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0D0C0000)
...
#define	dumo_cmd_sm_set_sc_remote_oob_data_id                       	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x110F0000)
#define	dumo_cmd_sm_use_sc_oob_id                                   	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x120F0000)
#define	dumo_cmd_sm_add_to_filter_accept_list_id                    	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x130F0000)
#define	dumo_cmd_sm_set_debug_mode_id                               	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x140F0000)
...
#define	dumo_cmd_iap_send_location_info_id                          	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0B100000)
#define	dumo_cmd_iap_get_protocol_session_id_id                     	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_cmd|0x0C100000)
...
#define	dumo_rsp_system_get_info_id                                 	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0B010000)
#define	dumo_rsp_system_get_app_version_id                          	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0C010000)
...
#define	dumo_rsp_bt_gap_set_power_vector_id                         	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0C020000)
...
#define	dumo_rsp_le_gap_enable_accept_list_filtering_id             	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0D030000)
...
#define	dumo_rsp_hardware_set_spi_configuration_id                  	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0D0C0000)
...
#define	dumo_rsp_sm_set_sc_remote_oob_data_id                       	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x110F0000)
#define	dumo_rsp_sm_use_sc_oob_id                                   	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x120F0000)
#define	dumo_rsp_sm_add_to_filter_accept_list_id                    	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x130F0000)
#define	dumo_rsp_sm_set_debug_mode_id                               	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x140F0000)
...
#define	dumo_rsp_iap_send_location_info_id                          	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0B100000)
#define	dumo_rsp_iap_get_protocol_session_id_id                     	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_rsp|0x0C100000)
...
#define	dumo_evt_hardware_bluetooth_controller_error_id             	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_evt|0x020C0000)
...
#define	dumo_evt_iap_start_location_info_id                         	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_evt|0x09100000)
#define	dumo_evt_iap_stop_location_info_id                          	(((uint32)dumo_dev_type_dumo)|dumo_msg_type_evt|0x0A100000)
...
typedef enum dumo_error
{
	...
	dumo_err_hardware_bluetooth_controller_response_timeout                                 =dumo_errspc_hardware+7,   //External Bluetooth Controller is unresponsive. To recover restart (or power cycle) the BT122 module.
	...
	dumo_err_power_vector_pattern_mismatch                                                  =dumo_errspc_bg+150,       //Power vector coordinates in indexes from 0 to 8 have wrong values.
	dumo_err_max_power_exceeded                                                             =dumo_errspc_bg+151,       //Maximum power value is too high.
	dumo_err_wrong_power_step                                                               =dumo_errspc_bg+152,       //Power steps between levels need to be constant and correct.
...
PACKSTRUCT(struct dumo_msg_system_get_info_rsp_t
{
	uint16	major;
	uint16	minor;
	uint16	patch;
...
PACKSTRUCT(struct dumo_msg_system_get_app_version_rsp_t
{
	uint16	app_version;
	uint16	result;
});
...
PACKSTRUCT(struct dumo_msg_bt_gap_set_power_vector_cmd_t
{
	uint8	modulation;
	uint8array	power_vector;
});

PACKSTRUCT(struct dumo_msg_bt_gap_set_power_vector_rsp_t
{
	uint16	result;
});
...
PACKSTRUCT(struct dumo_msg_le_gap_enable_accept_list_filtering_cmd_t
{
	uint8	enable;
});

PACKSTRUCT(struct dumo_msg_le_gap_enable_accept_list_filtering_rsp_t
{
	uint16	result;
});
...
PACKSTRUCT(struct dumo_msg_hardware_set_spi_configuration_cmd_t
{
	uint8	polarity;
	uint8	phase;
	uint8	endianness;
...
PACKSTRUCT(struct dumo_msg_hardware_set_spi_configuration_rsp_t
{
	uint16	result;
});
...
PACKSTRUCT(struct dumo_msg_hardware_bluetooth_controller_error_evt_t
{
	uint16	status;
...
PACKSTRUCT(struct dumo_msg_sm_confirm_bonding_cmd_t
{
	uint8	connection;
	uint8	confirm;
});
...
PACKSTRUCT(struct dumo_msg_sm_set_sc_remote_oob_data_cmd_t
{
	uint8array	oob_data;
});

PACKSTRUCT(struct dumo_msg_sm_set_sc_remote_oob_data_rsp_t
{
	uint16	result;
});

PACKSTRUCT(struct dumo_msg_sm_use_sc_oob_cmd_t
{
	uint8	enable;
});

PACKSTRUCT(struct dumo_msg_sm_use_sc_oob_rsp_t
{
	uint16	result;
	uint8array	oob_data;
});

PACKSTRUCT(struct dumo_msg_sm_add_to_filter_accept_list_cmd_t
{
	bd_addr	address;
	uint8	address_type;
});

PACKSTRUCT(struct dumo_msg_sm_add_to_filter_accept_list_rsp_t
{
	uint16	result;
});

PACKSTRUCT(struct dumo_msg_sm_set_debug_mode_cmd_t
{
	uint8	mode;
	uint8	value;
});

PACKSTRUCT(struct dumo_msg_sm_set_debug_mode_rsp_t
{
	uint16	result;
});
...
PACKSTRUCT(struct dumo_msg_iap_send_location_info_cmd_t
{
	uint8	endpoint;
	uint8array	nmea_sentence;
});

PACKSTRUCT(struct dumo_msg_iap_send_location_info_rsp_t
{
	uint16	result;
});

PACKSTRUCT(struct dumo_msg_iap_get_protocol_session_id_cmd_t
{
	uint8	endpoint;
});

PACKSTRUCT(struct dumo_msg_iap_get_protocol_session_id_rsp_t
{
	uint16	result;
	uint16	session_id;
});
...
PACKSTRUCT(struct dumo_msg_iap_start_location_info_evt_t
{
	uint8	endpoint;
	uint8	parameters;
});

PACKSTRUCT(struct dumo_msg_iap_stop_location_info_evt_t
{
	uint8	endpoint;
});
...
union{
	...
	struct dumo_msg_system_get_info_rsp_t                                  rsp_system_get_info;
	struct dumo_msg_system_get_app_version_rsp_t                           rsp_system_get_app_version;
	...
	struct dumo_msg_bt_gap_set_power_vector_cmd_t                          cmd_bt_gap_set_power_vector;
	...
	struct dumo_msg_bt_gap_set_power_vector_rsp_t                          rsp_bt_gap_set_power_vector;
	...
	struct dumo_msg_le_gap_enable_accept_list_filtering_cmd_t              cmd_le_gap_enable_accept_list_filtering;
	...
	struct dumo_msg_le_gap_enable_accept_list_filtering_rsp_t              rsp_le_gap_enable_accept_list_filtering;
	...
	struct dumo_msg_hardware_set_spi_configuration_cmd_t                   cmd_hardware_set_spi_configuration;
	...
	struct dumo_msg_hardware_bluetooth_controller_error_evt_t              evt_hardware_bluetooth_controller_error;
	...
	struct dumo_msg_hardware_set_spi_configuration_rsp_t                   rsp_hardware_set_spi_configuration;
	...
	struct dumo_msg_sm_confirm_bonding_cmd_t                               cmd_sm_confirm_bonding;
	...
	struct dumo_msg_sm_set_sc_remote_oob_data_cmd_t                        cmd_sm_set_sc_remote_oob_data;
	struct dumo_msg_sm_use_sc_oob_cmd_t                                    cmd_sm_use_sc_oob;
	struct dumo_msg_sm_add_to_filter_accept_list_cmd_t                     cmd_sm_add_to_filter_accept_list;
	struct dumo_msg_sm_set_debug_mode_cmd_t                                cmd_sm_set_debug_mode;
	...
	struct dumo_msg_sm_set_sc_remote_oob_data_rsp_t                        rsp_sm_set_sc_remote_oob_data;
	struct dumo_msg_sm_use_sc_oob_rsp_t                                    rsp_sm_use_sc_oob;
	struct dumo_msg_sm_add_to_filter_accept_list_rsp_t                     rsp_sm_add_to_filter_accept_list;
	struct dumo_msg_sm_set_debug_mode_rsp_t                                rsp_sm_set_debug_mode;
	...
	struct dumo_msg_iap_send_location_info_cmd_t                           cmd_iap_send_location_info;
	struct dumo_msg_iap_get_protocol_session_id_cmd_t                      cmd_iap_get_protocol_session_id;
	...
	struct dumo_msg_iap_start_location_info_evt_t                          evt_iap_start_location_info;
	struct dumo_msg_iap_stop_location_info_evt_t                           evt_iap_stop_location_info;
	...
	struct dumo_msg_iap_send_location_info_rsp_t                           rsp_iap_send_location_info;
	struct dumo_msg_iap_get_protocol_session_id_rsp_t                      rsp_iap_get_protocol_session_id;
...
#define dumo_cmd_system_get_info() \
{\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)0+0)>>8)))|((((uint32)0+0)&0xff)<<8)|((uint32)0x1<<16)|((uint32)0xb<<24);\
bglib_output(4+0,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
/** This command can be used to get a user application version number. **/
#define dumo_cmd_system_get_app_version() \
{\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)0+0)>>8)))|((((uint32)0+0)&0xff)<<8)|((uint32)0x1<<16)|((uint32)0xc<<24);\
bglib_output(4+0,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
/**
...
#define dumo_cmd_bt_gap_set_power_vector(MODULATION,POWER_VECTOR_LEN,POWER_VECTOR_DATA) \
{\
bglib_temp_msg.cmd_bt_gap_set_power_vector.modulation=(MODULATION);\
bglib_temp_msg.cmd_bt_gap_set_power_vector.power_vector.len=(POWER_VECTOR_LEN);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)2+bglib_temp_msg.cmd_bt_gap_set_power_vector.power_vector.len)>>8)))|((((uint32)2+bglib_temp_msg.cmd_bt_gap_set_power_vector.power_vector.len)&0xff)<<8)|((uint32)0x2<<16)|((uint32)0xc<<24);\
bglib_output(4+2,(uint8*)&bglib_temp_msg,bglib_temp_msg.cmd_bt_gap_set_power_vector.power_vector.len,(uint8*)POWER_VECTOR_DATA);\
}
...
/**
                Enable or disable accept list filtering. The setting will be effective the next time that scanning is enabled. To add devices to the filter accept list, either bond with the device or add it manually with {a href="#cmd_sm_add_to_filter_accept_list"}dumo_cmd_sm_add_to_filter_accept_list.{/a}
            **/
#define dumo_cmd_le_gap_enable_accept_list_filtering(ENABLE) \
{\
bglib_temp_msg.cmd_le_gap_enable_accept_list_filtering.enable=(ENABLE);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)1+0)>>8)))|((((uint32)1+0)&0xff)<<8)|((uint32)0x3<<16)|((uint32)0xd<<24);\
bglib_output(4+1,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
...
/**
			...
			{br}For detailed information, see Bluetooth Specification 4.2, vol. 2, part E, section 7.5.6 (Read Clock Command).
			**/
...
/**This command can be used to send data to the defined endpoint.
            {br}{br}When this command is issued data to be sent is placed to send queue for sending.
            **/
...
/**This command can be used to read the specified channel of the A/D converter in the module. Note that the ADC channels must be configured
            in the hardware.xml file, as described in the module Configuration Guide. Note that only channels 0 through 2 are connected.{br}
...
#define dumo_cmd_hardware_read_write_spi(READ_LENGTH,DATA_LEN,DATA_DATA) \
{\
...
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)2+bglib_temp_msg.cmd_hardware_read_write_spi.data.len)>>8)))|((((uint32)2+bglib_temp_msg.cmd_hardware_read_write_spi.data.len)&0xff)<<8)|((uint32)0xc<<16)|((uint32)0xb<<24);\
bglib_output(4+2,(uint8*)&bglib_temp_msg,bglib_temp_msg.cmd_hardware_read_write_spi.data.len,(uint8*)DATA_DATA);\
}
...
#define dumo_cmd_hardware_set_spi_configuration(POLARITY,PHASE,ENDIANNESS,BAUD) \
{\
bglib_temp_msg.cmd_hardware_set_spi_configuration.polarity=(POLARITY);\
bglib_temp_msg.cmd_hardware_set_spi_configuration.phase=(PHASE);\
bglib_temp_msg.cmd_hardware_set_spi_configuration.endianness=(ENDIANNESS);\
bglib_temp_msg.cmd_hardware_set_spi_configuration.baud=(BAUD);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)7+0)>>8)))|((((uint32)7+0)&0xff)<<8)|((uint32)0xc<<16)|((uint32)0xd<<24);\
bglib_output(4+7,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
...
#define dumo_cmd_sm_configure(FLAGS,IO_CAPABILITIES) \
{\
bglib_temp_msg.cmd_sm_configure.flags=(FLAGS);\
...
/**This command can be used to list all bondings stored in the bonding database. The entry in the bonding database can be either bonding or accept list filtering device. Bondings are reported by using the {a href="#evt_sm_list_bonding_entry"}
...
/**This command can be used to confirm bonding when {a href="#evt_sm_bonding_request"}dumo_evt_sm_bonding_request{/a} event is received.**/
#define dumo_cmd_sm_confirm_bonding(CONNECTION,CONFIRM) \
{\
bglib_temp_msg.cmd_sm_confirm_bonding.connection=(CONNECTION);\
bglib_temp_msg.cmd_sm_confirm_bonding.confirm=(CONFIRM);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)2+0)>>8)))|((((uint32)2+0)&0xff)<<8)|((uint32)0xf<<16)|((uint32)0xc<<24);\
bglib_output(4+2,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
...
/**
                Set OOB data and confirm values (out-of-band encryption) received from the remote device for secure connections pairing. OOB data must be enabled with {a href="#cmd_sm_use_sc_oob"}dumo_cmd_sm_use_sc_oob{/a} before setting the remote device OOB data.
            **/
#define dumo_cmd_sm_set_sc_remote_oob_data(OOB_DATA_LEN,OOB_DATA_DATA) \
{\
bglib_temp_msg.cmd_sm_set_sc_remote_oob_data.oob_data.len=(OOB_DATA_LEN);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)1+bglib_temp_msg.cmd_sm_set_sc_remote_oob_data.oob_data.len)>>8)))|((((uint32)1+bglib_temp_msg.cmd_sm_set_sc_remote_oob_data.oob_data.len)&0xff)<<8)|((uint32)0xf<<16)|((uint32)0x11<<24);\
bglib_output(4+1,(uint8*)&bglib_temp_msg,bglib_temp_msg.cmd_sm_set_sc_remote_oob_data.oob_data.len,(uint8*)OOB_DATA_DATA);\
}
/**
                Enable the use of OOB data (out-of-band encryption data) for a device for secure connections pairing. Enabling will generate new OOB data and confirm values, which can be sent to the remote device. After enabling the secure connections OOB data, the remote devices OOB data can be set with {a href="#cmd_sm_set_sc_remote_oob_data"}dumo_cmd_sm_set_sc_remote_oob_data.{/a} Calling this function will erase any set remote device OOB data and confirm values. The device will not allow any other bonding if OOB data is set. The secure connections OOB data cannot be enabled simultaneously with legacy pairing OOB data.
            **/
#define dumo_cmd_sm_use_sc_oob(ENABLE) \
{\
bglib_temp_msg.cmd_sm_use_sc_oob.enable=(ENABLE);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)1+0)>>8)))|((((uint32)1+0)&0xff)<<8)|((uint32)0xf<<16)|((uint32)0x12<<24);\
bglib_output(4+1,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
/**
                Add device to filter accept list, which can be enabled with {a href="#cmd_le_gap_enable_accept_list_filtering"}dumo_cmd_le_gap_enable_accept_list_filtering.{/a}
            **/
#define dumo_cmd_sm_add_to_filter_accept_list(ADDRESS,ADDRESS_TYPE) \
{\
memcpy(&bglib_temp_msg.cmd_sm_add_to_filter_accept_list.address,(ADDRESS),sizeof(hw_addr));\
bglib_temp_msg.cmd_sm_add_to_filter_accept_list.address_type=(ADDRESS_TYPE);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)7+0)>>8)))|((((uint32)7+0)&0xff)<<8)|((uint32)0xf<<16)|((uint32)0x13<<24);\
bglib_output(4+7,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
/**
                Set Security Manager in debug mode. In this mode, the secure connections bonding uses known debug keys, so that the encrypted packet can be opened by Bluetooth protocol analyzer. To disable the debug mode, restart the device. {p}Bondings made in debug mode are unsecure.{/p}
            **/
#define dumo_cmd_sm_set_debug_mode(MODE,VALUE) \
{\
bglib_temp_msg.cmd_sm_set_debug_mode.mode=(MODE);\
bglib_temp_msg.cmd_sm_set_debug_mode.value=(VALUE);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)2+0)>>8)))|((((uint32)2+0)&0xff)<<8)|((uint32)0xf<<16)|((uint32)0x14<<24);\
bglib_output(4+2,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
...
/**
                This command is used to send location information to an iOS device.
            **/
#define dumo_cmd_iap_send_location_info(ENDPOINT,NMEA_SENTENCE_LEN,NMEA_SENTENCE_DATA) \
{\
bglib_temp_msg.cmd_iap_send_location_info.endpoint=(ENDPOINT);\
bglib_temp_msg.cmd_iap_send_location_info.nmea_sentence.len=(NMEA_SENTENCE_LEN);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)2+bglib_temp_msg.cmd_iap_send_location_info.nmea_sentence.len)>>8)))|((((uint32)2+bglib_temp_msg.cmd_iap_send_location_info.nmea_sentence.len)&0xff)<<8)|((uint32)0x10<<16)|((uint32)0xb<<24);\
bglib_output(4+2,(uint8*)&bglib_temp_msg,bglib_temp_msg.cmd_iap_send_location_info.nmea_sentence.len,(uint8*)NMEA_SENTENCE_DATA);\
}
/**
                This command is used to read External Accessory Protocol Session ID.
            **/
#define dumo_cmd_iap_get_protocol_session_id(ENDPOINT) \
{\
bglib_temp_msg.cmd_iap_get_protocol_session_id.endpoint=(ENDPOINT);\
bglib_temp_msg.header=(((uint32)dumo_msg_type_cmd|dumo_dev_type_dumo|(((uint32)1+0)>>8)))|((((uint32)1+0)&0xff)<<8)|((uint32)0x10<<16)|((uint32)0xc<<24);\
bglib_output(4+1,(uint8*)&bglib_temp_msg,0,(uint8*)NULL);\
}
/**
