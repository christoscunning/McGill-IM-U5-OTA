...
typedef enum bg_error
{
	...
	bg_err_hardware_bluetooth_controller_response_timeout                                 =bg_errspc_hardware+7,   //External Bluetooth Controller is unresponsive. To recover restart (or power cycle) the BT122 module.
	...
	bg_err_power_vector_pattern_mismatch                                                  =bg_errspc_bg+150,       //Power vector coordinates in indexes from 0 to 8 have wrong values.
	bg_err_max_power_exceeded                                                             =bg_errspc_bg+151,       //Maximum power value is too high.
	bg_err_wrong_power_step                                                               =bg_errspc_bg+152,       //Power steps between levels need to be constant and correct.
